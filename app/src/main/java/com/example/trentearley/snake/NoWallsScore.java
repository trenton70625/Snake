...
public class NoWallsScore extends AppCompatActivity {
    ...
    private RelativeLayout noWallsLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        noWallsLayout = (RelativeLayout) findViewById(R.id.no_walls_score_layout);
        adView = new AdView(this);
        adView.setAdSize(AdSize.SMART_BANNER);
        adView.setAdUnitId(GameSettings.MY_AD_UNIT_ID);
        noWallsLayout.addView(adView);
    ...
    private void initScore(){
        ...
        animation.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                score.setBackgroundResource(R.mipmap.menu_options);
            }
